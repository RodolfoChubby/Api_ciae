...
const Defunciones = sequelize.define('Defunciones', {
    id_defunciones: {
    ...
    tableName: 'tbl_defunciones',
    timestamps: false // Ajusta esto según tu necesidad
},
    {
        indexes: [
            {
                unique: true,
                fields: ['id_defunciones']
            },
            {
                unique: false,
                fields: ['folio']
            ...
            {
                unique: false,
                fields: ['fechadefuncion']
            }
        ]
    });

module.exports = Defunciones;
